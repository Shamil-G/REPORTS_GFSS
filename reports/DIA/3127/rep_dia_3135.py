...
SELECT
    br.RFBN_ID,
    br.NAME,
    round(AVG(DISTINCT CASE WHEN rfpm_id = '07020101' THEN sfa.sum_all END), 2) AV01,
    round(AVG(DISTINCT CASE WHEN rfpm_id = '07020102' THEN sfa.sum_all END), 2) AV02,
    round(AVG(DISTINCT CASE WHEN rfpm_id = '07020103' THEN sfa.sum_all END), 2) AV03,
