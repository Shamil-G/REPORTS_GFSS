...
report_name = '3139 - Структура получателей в разрезе пола'
report_code = '3139'
...
def format_worksheet(worksheet, common_format):
    ...
    worksheet.set_column(1, 16, 14)

    worksheet.merge_range(2, 0, 4, 0, 'Наименование\nрегиона', common_format)

    worksheet.merge_range(2, 1, 2, 16, 'Степень утраты трудоспособности, %', common_format)

    worksheet.merge_range(3, 1, 3, 4, '80-100', common_format)
    worksheet.merge_range(3, 5, 3, 8, '60-80', common_format)
    worksheet.merge_range(3, 9, 3, 12, '30-60', common_format)
    worksheet.merge_range(3, 13, 3, 16, 'Всего', common_format)

    for start_col in [1, 5, 9, 13]:
    ...
    with oracledb.connect(user=db_user, password=db_password, dsn=db_dsn) as connection:
        with connection.cursor() as cursor:
            ...
            for col in range(1, 17):
                ...
                fmt = total_money_format if col in (2, 4, 6, 8, 10, 12, 14, 16) else total_digital_format
