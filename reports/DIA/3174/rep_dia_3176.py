...
report_name = '3176 - Градация СМД принятого для исчисления выплаты'
report_code = '3176'
...
def format_worksheet(worksheet, common_format):
    ...
    worksheet.write(3, 2, 'Первым ребенком', common_format)
    worksheet.write(3, 3, 'Вторым ребенком', common_format)
    worksheet.write(3, 4, 'Третьим ребенком', common_format)
    worksheet.write(3, 5, 'Четвертым и более ребенком', common_format)
