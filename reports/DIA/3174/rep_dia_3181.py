...
report_name = '3181 - Половозрастная структура получателей'
report_code = '3181'
...
def format_worksheet(worksheet, common_format):
    ...
    worksheet.merge_range(
        2, 1, 2, 3,
        'Количество получателей социальной выплаты на случай потери дохода в связи с уходом за ребенком до достижения им возраста 1 года, человек',
        common_format
    )
