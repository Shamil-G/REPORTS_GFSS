...
def format_worksheet(worksheet, common_format):
    ...
    worksheet.write(3, 0, 'Количество месяцев', common_format)

    worksheet.write(3, 1, '1 иждивенец', common_format)
    worksheet.write(3, 2, '2 иждивенца', common_format)
    worksheet.write(3, 3, '3 иждивенца', common_format)
    worksheet.write(3, 4, '4 и более иждивенца', common_format)
