...
SELECT
  y,
  COUNT(DISTINCT CASE WHEN sex = 1 THEN PNCD_ID END) CNTM,
  COUNT(DISTINCT CASE WHEN sex = 0 THEN PNCD_ID END) CNTW,
...
def format_worksheet(worksheet, common_format):
    ...
    worksheet.write(2, 0, 'Год назначения', common_format)
    worksheet.write(2, 1, 'Мужчины', common_format)
    worksheet.write(2, 2, 'Женщины', common_format)
    worksheet.write(2, 3, 'Всего', common_format)
