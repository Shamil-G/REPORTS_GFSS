...
report_name = '3152 - Структура получателей в разрезе пола'
report_code = '3152'
...
def format_worksheet(worksheet, common_format):
    ...
    worksheet.set_column(1, 20, 14)

    worksheet.merge_range(2, 0, 4, 0, 'Наименование\nрегиона', common_format)

    worksheet.merge_range(2, 1, 2, 16, 'Количество иждивенцев', common_format)

    worksheet.merge_range(2, 17, 3, 20, 'Всего', common_format)

    worksheet.merge_range(3, 1, 3, 4, '1 иждивенец', common_format)
    worksheet.merge_range(3, 5, 3, 8, '2 иждивенца', common_format)
    worksheet.merge_range(3, 9, 3, 12, '3 иждивенца', common_format)
    worksheet.merge_range(3, 13, 3, 16, '4 и более иждивенца', common_format)
