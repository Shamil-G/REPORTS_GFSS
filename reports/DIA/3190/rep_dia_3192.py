...
report_name = '3192 - Потеря кормильца'
report_code = '3192'
...
SELECT
  rfbn,
  br.name,
  COUNT(DISTINCT CASE WHEN rfpm = '07010101' AND sex = 1 THEN PNCD_ID END) CNT01M,
  SUM(CASE WHEN rfpm = '07010101' AND sex = 1 THEN sm ELSE 0 END) SM01M,
  COUNT(DISTINCT CASE WHEN rfpm = '07010101' AND sex = 0 THEN PNCD_ID END) CNT01W,
  SUM(CASE WHEN rfpm = '07010101' AND sex = 0 THEN sm ELSE 0 END) SM01W,
  COUNT(DISTINCT CASE WHEN rfpm = '07010102' AND sex = 1 THEN PNCD_ID END) CNT02M,
  SUM(CASE WHEN rfpm = '07010102' AND sex = 1 THEN sm ELSE 0 END) SM02M,
  COUNT(DISTINCT CASE WHEN rfpm = '07010102' AND sex = 0 THEN PNCD_ID END) CNT02W,
  SUM(CASE WHEN rfpm = '07010102' AND sex = 0 THEN sm ELSE 0 END) SM02W,
  COUNT(DISTINCT CASE WHEN rfpm = '07010103' AND sex = 1 THEN PNCD_ID END) CNT03M,
  SUM(CASE WHEN rfpm = '07010103' AND sex = 1 THEN sm ELSE 0 END) SM03M,
  COUNT(DISTINCT CASE WHEN rfpm = '07010103' AND sex = 0 THEN PNCD_ID END) CNT03W,
  SUM(CASE WHEN rfpm = '07010103' AND sex = 0 THEN sm ELSE 0 END) SM03W,
  COUNT(DISTINCT CASE WHEN rfpm = '07010104' AND sex = 1 THEN PNCD_ID END) CNT04M,
  SUM(CASE WHEN rfpm = '07010104' AND sex = 0 THEN sm ELSE 0 END) SM04W,
  COUNT(DISTINCT CASE WHEN rfpm = '07010104' AND sex = 0 THEN PNCD_ID END) CNT04W,
  SUM(CASE WHEN rfpm = '07010104' AND sex = 1 THEN sm ELSE 0 END) SM04M,
...
def format_worksheet(worksheet, common_format):
    ...
    worksheet.merge_range(2, 2, 2, 17, 'Количество иждивенцев', common_format)

    worksheet.merge_range(3, 2, 3, 5, '1 иждивенец', common_format)
    worksheet.merge_range(3, 6, 3, 9, '2 иждивенца', common_format)
    worksheet.merge_range(3, 10, 3, 13, '3 иждивенца', common_format)
    worksheet.merge_range(3, 14, 3, 17, '4 и более иждивенца', common_format)
