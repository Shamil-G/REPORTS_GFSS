...
report_name = '3158 - Градация размеров получателей'
report_code = '3158'
...
FROM(
SELECT
  FIRST_VALUE(D.RFPM_ID) OVER(PARTITION BY D.SOURCE_ID ORDER BY D.PNCP_DATE DESC) RFPM,
  d.pncd_id,
  d.source_id,
  ph.sum_pay,
